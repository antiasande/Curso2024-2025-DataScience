...
Original file is located at
    https://colab.research.google.com/drive/1cNiEF2yn3ZqCApGm79wZCr9ahrMrvV5q
...
q5 = """
    ...
    WHERE {
      ...
      ?animal ns:knows ?other_animal .
      ?other_animal rdf:type ns:Animal .
      ?animal ns:name ?animal_name .
    }
"""
# Visualize the results
for r in g.query(q5):
