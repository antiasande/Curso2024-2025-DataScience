...
Original file is located at
    https://colab.research.google.com/drive/19JDy7xf4Cc9TUJhj5e-TSu5pEzPle6EH
...
g.add((ns.JaneSmithers, schema.email, Literal("jane.smithers@university.com")))
...
g.add((ns.JohnSmith, schema.worksAt, ex.UPM))
for s, p, o in g:
  print(s,p,o)
